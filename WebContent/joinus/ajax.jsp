	...
	<div id="body">
		...
		/* 				var notices = [
						...
						morebutton.onclick = function(){
								...
								/* var data = eval('[{code:"1",title:"오오오"},{code:"2",title:"육육육"},{code:"3",title:"칠칠칠"}]'); */
								/* var data = JSON.parse('[{"code":"1","title":"오오오"},{"code":"2","title":"육육육"},{"code":"3","title":"칠칠칠"}]');
								alert(data[1].title); */
								/* 
								var temp = "3+7";
								var x = eval(temp); */
								...
								request.open("GET","ajax-data.jsp",false);
								request.send();
